...
//        distanceMap.put(Units.feetToMeters(12.96 + 3.35), 4300.0);
        ...
        distanceMap.put(Units.feetToMeters(2.42 + measurementOffset), 2800.0-250.0);
        distanceMap.put(Units.feetToMeters(3.94 + measurementOffset), 3000.0-260.0);
        distanceMap.put(Units.feetToMeters(4.98 + measurementOffset), 3150.0-270.0);
        distanceMap.put(Units.feetToMeters(5.79 + measurementOffset), 3250.0-280.0);
        distanceMap.put(Units.feetToMeters(6.76 + measurementOffset), 3350.0-300.0);
        distanceMap.put(Units.feetToMeters(8.82 + measurementOffset), 3550.0-450.0);
        distanceMap.put(Units.feetToMeters(7.5 + measurementOffset), 3450.0-550.0);
        distanceMap.put(Units.feetToMeters(9.92 + measurementOffset), 3850.0-600.0);
        distanceMap.put(Units.feetToMeters(11.67 + measurementOffset), 4150.0-650.0);
        distanceMap.put(Units.feetToMeters(13.92 + measurementOffset), 4300.0-780.0);
    }
