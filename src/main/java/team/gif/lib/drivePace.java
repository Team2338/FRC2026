...
public enum drivePace {
    COAST_FR(Robot.swerveDrive.getConstants().COAST_SPEED_METERS_PER_SECOND, true),
    COAST_RR(Robot.swerveDrive.getConstants().COAST_SPEED_METERS_PER_SECOND, false),
    COAST_ROT(Robot.swerveDrive.getConstants().COAST_SPEED_METERS_PER_SECOND, false),
...
//    SLOW_RR(Constants.Drivetrain.SLOW_SPEED_METERS_PER_SECOND, false),
    BOOST_FR(Robot.swerveDrive.getConstants().BOOST_SPEED_METERS_PER_SECOND, true);
